...
| # | Description | L1 | L2 | L3 | CWE |
| :---: | :--- | :---: | :---:| :---: | :---: |
| **6.2.1** | Verificar que todos os módulos criptográficos falham de maneira segura, e erros são tratados de maneira que não permitam ataques de Padding Oracle. | ✓ | ✓ | ✓ | 310 |
