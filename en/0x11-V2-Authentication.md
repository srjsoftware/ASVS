...
| **2.5.6** | Verificar que "esqueci a senha" ou outro caminho de recuperação usam um mecanismo de recuperação seguro, como OTP baseado em tempo (TOTP) ou outro token de software, notificações push móveis, ou outro método de recuperação offline. ([C6](https://owasp.org/www-project-proactive-controls/#div-numbering)) | ✓ | ✓ | ✓ | 640 | 5.1.1.2 |
