...
| :---: | :--- | :---: | :---:| :---: | :---: |
| **7.1.1** | Verificar que a aplicação não loga detalhes de credenciais ou pagamentos. Tokens de sessão só devem ser armazenados em logs em forma de hash irreversível. ([C9, C10](https://owasp.org/www-project-proactive-controls/#div-numbering)) | ✓ | ✓ | ✓ | 532 |
| **7.1.2** | Verificar que a aplicação não loga outros dados sensíveis como definidos em leis de privacidade locais ou políticas de segurança relevantes. ([C9](https://owasp.org/www-project-proactive-controls/#div-numbering)) | ✓ | ✓ | ✓ | 532 |
...
| # | Description | L1 | L2 | L3 | CWE |
| :---: | :--- | :---: | :---:| :---: | :---: |
| **7.4.1** | Verificar que uma mensagem genérica é exibida quando ocorre um erro inesperado ou sensível à segurança, potencialmente com um ID único ao qual a equipe de suporte pode usar para investigar. ([C10](https://owasp.org/www-project-proactive-controls/#div-numbering)) | ✓ | ✓ | ✓ | 210 |
